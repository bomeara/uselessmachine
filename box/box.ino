...
const int frontSwitchPin = 15;
const int fingerServoPin = 9;
const int lidServoPin = 10;
int fingerMinRotation = 0; // when finger fully retracted
int fingerNearlyMaxRotation = 165; // when finger nearly fully extended
int fingerMaxRotation = 175; // when finger fully extended
